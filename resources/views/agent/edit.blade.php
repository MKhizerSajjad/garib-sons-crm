                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <input id="email" name="email" type="mail" class="form-control @error('email') is-invalid @enderror" placeholder="Email" value="{{ $user->email }}" readonly>
                                            @error('email')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <input id="phone" name="phone" type="tel" class="form-control @error('phone') is-invalid @enderror" placeholder="Phone" value="{{ $user->phone }}" readonly>
                                            @error('phone')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select id="team_leader" name="team_leader" class="select2 form-control @error('team_leader') is-invalid @enderror">
                                                ...
                                                @foreach ($teamLeaders as $key => $teamLeader)
                                                    <option value="{{  $teamLeader->id }}" {{ old('team_leader', $user->user_id) == $teamLeader->id ? 'selected' : '' }}>{{ $teamLeader->first_name . ' ' . $teamLeader->last_name }}</option>
                                                @endforeach
                                            </select>
                                            @error('team_leader')
                                                <span class="invalid-feedback" role="alert">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select id="user_status" name="status" class="select2 form-control @error('status') is-invalid @enderror">
                                                ...
                                                @foreach (getGenStatus('general') as $key => $status)
                                                    <option value="{{ ++$key }}" @if($key == old('status', $user->status)) selected @endif>{{ $status }}</option>
                                                @endforeach
                                            </select>
                                            @error('status')
                                                <span class="invalid-feedback" role="alert">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <span class="text text-danger">(Enter Password to update/change)</span>
