                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-end gap-2" bis_skin_checked="1">
                                <a href="{{ route('university.create') }}" class="btn btn-primary waves-effect waves-light"> <i class="bx bx-plus me-1"></i> Add New</a>
                            </div>
                                        ...
                                        <tbody>
                                            @foreach ($data as $key => $uni)
                                                <tr>
                                                    ...
                                                    <td>{!! getGenStatus('general', $uni->status, 'badge') !!}</td>
                                                    <td class="text-center"> <a href="{{ route('university.edit', $uni->id) }}"><i class="bx bx-pencil"></i></a></td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
