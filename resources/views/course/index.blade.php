                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-end gap-2" bis_skin_checked="1">
                                <a href="{{ route('course.create') }}" class="btn btn-primary waves-effect waves-light"> <i class="bx bx-plus me-1"></i> Add New</a>
                            </div>
                                    ...
                                    <table class="table mb-0 table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center" width="10%" class="text-center">Options</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            @foreach ($data as $key => $uni)
                                                <tr>
                                                    ...
                                                    <td>{{ $uni->name }}</td>
                                                    <td class="text-center">{{ $uni->years }}</td>
                                                    <td class="text-center">{!! getGenStatus('general', $uni->status, 'badge') !!}</td>
                                                    <td class="text-center"> <a href="{{ route('course.edit', $uni->id) }}"><i class="bx bx-pencil"></i></a></td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
